...
WebUI.setText(findTestObject('Object Repository/Page_STORE/input_Username_loginusername'), 'ragdoll')

WebUI.setText(findTestObject('Object Repository/Page_STORE/input_Password_loginpassword'), 'ras123')

WebUI.click(findTestObject('Object Repository/Page_STORE/button_Log in'))

WebUI.click(findTestObject('Object Repository/Page_STORE/img_650_card-img-top img-fluid'))
...
WebUI.setText(findTestObject('Object Repository/Page_STORE/input_Name_name'), 'ragdoll')
...
WebUI.setText(findTestObject('Object Repository/Page_STORE/input_Credit card_card'), 'bni')

WebUI.setText(findTestObject('Object Repository/Page_STORE/input_Month_month'), 'desember')
