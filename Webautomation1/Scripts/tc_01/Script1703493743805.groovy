...
WebUI.setText(findTestObject('Object Repository/Page_STORE/input_Username_sign-username'), 'ragdoll')

WebUI.setText(findTestObject('Page_STORE/input_Password_sign-password'), 'ras123')
